# Generated by Django 3.1.7 on 2021-11-07 01:55
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('requestorEmail', models.CharField(default='None', max_length=32)),
                ('status', models.CharField(default='Requested', max_length=32)),
                ('userstamp', models.CharField(default='None', max_length=32)),
                ('createdDate', models.DateTimeField(auto_now_add=True)),
                ('project', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='requests', to='fundraising.project')),
            ],
        ),
        migrations.CreateModel(
            name='User',
